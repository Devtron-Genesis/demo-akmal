...
class __TwigTemplate_146489df0906f80d7a73697700269e4e2d21a2bced5533cef1707b6cd26d1d91 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["set" => 27];
        $filters = ["clean_class" => 29, "join" => 39, "raw" => 45, "safe_join" => 46, "t" => 52];
        $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['set'],
                ['clean_class', 'join', 'raw', 'safe_join', 't'],
                []
            );
...
";
    ...
    {
        return new Source("", "themes/bootstrap_mint/templates/layout/html.html.twig", "/var/www/ecommerce-drupal-8/themes/bootstrap_mint/templates/layout/html.html.twig");
    }
}
